...
export default tseslint.config(
  ...
  // Baseline. Nothing architectural — the hooks rules are correctness insurance;
  // the four sections below are the architecture.
  {
    files: ['**/*.{ts,tsx}'],
    ...
    settings: {
      'import/resolver': {
        typescript: {
          ...
          // Two projects is deliberate; no warning needed.
  ...
  // R1's one exemption: the composition root. Something has to mount the store and
  // the router. A two-file allowlist, not a folder — `src/app` is full of layouts
  // and screens R1 still polices.
  {
