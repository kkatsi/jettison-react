...
Scope, stated plainly: long-lived enterprise SPAs. No SSR, no RSC, by thesis. The starting point is [bulletproof-react](https://github.com/alan2207/bulletproof-react) — feature folders, unidirectional flow, colocation — extended where enterprise codebases actually bleed: enforcement, falsifiable modularity, and governance that survives turnover.
